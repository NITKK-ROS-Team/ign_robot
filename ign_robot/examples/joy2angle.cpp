...
namespace joy2angle
{
class Joy2Angle : public rclcpp::Node
{
public:
  Joy2Angle(const rclcpp::NodeOptions & options)
  : Node("joy2angle", options)
  {
    joy_sub_ = this->create_subscription<sensor_msgs::msg::Joy>(
      "joy", 10, std::bind(&Joy2Angle::joy_callback, this, std::placeholders::_1));
...
RCLCPP_COMPONENTS_REGISTER_NODE(joy2angle::Joy2Angle)
